...
--
-- Host: localhost    Database: smartrent
-- ------------------------------------------------------
...
INSERT INTO `migrations` VALUES (1,'0001_01_01_000000_create_users_table',1),(2,'0001_01_01_000001_create_cache_table',1),(3,'0001_01_01_000002_create_jobs_table',1),(4,'2026_03_02_114006_create_properties_table',1),(5,'2026_03_03_152705_create_units_table',1),(6,'2026_03_05_122243_create_tenancies_table',1),(7,'2026_04_17_151342_add_active_to_tenancies_table',1),(8,'2026_04_20_084703_create_payments_table',1),(9,'2026_04_20_092243_add_phone_to_users_table',1),(10,'2026_04_20_114123_create_receipts_table',1);
...
CREATE TABLE `payments` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `payments_checkout_request_id_unique` (`checkout_request_id`),
...
CREATE TABLE `tenancies` (
  ...
  `rent_amount_snapshot` decimal(8,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `units` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `units_property_id_unit_number_unique` (`property_id`,`unit_number`),
...
CREATE TABLE `users` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `role` varchar(255) NOT NULL DEFAULT 'landlord',
  `email` varchar(255) NOT NULL,
...
INSERT INTO `users` VALUES (1,'Morgan','landlord','moitalelmorgan3@gmail.com',NULL,NULL,'$2y$12$HQTadKUa1KAufr4d3ok6O.JJRgkLbWXxGcWy6xmWYOk2mzBa5Lriy',NULL,'2026-04-22 04:30:55','2026-04-22 04:30:55');
...
-- Dump completed on 2026-04-22 10:52:42
